...
function init (){
  ...
  // const residentsAPI_URL = (window.location.hostname === '127.0.0.1' || window.location.hostname === 'localhost') ? 'http://localhost:3000/admin/residentList' : 'https://municipal-covid-tracker.herokuapp.com/admin/residentList';
